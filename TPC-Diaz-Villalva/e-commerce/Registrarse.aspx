<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registrarse.aspx.cs" Inherits="e_commerce.Registrarse" %>
            ...
            <div class="row">
                ...
                <div class="col-sm formulario">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <div class="input">
                            <asp:Button ID="btnLogin" OnClick="btnLogin_Click" runat="server" Text="CREAR CUENTA" />
                        </div>
